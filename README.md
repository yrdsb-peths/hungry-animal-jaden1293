...
Some new features that I have added to the game is a skull that falls down slower than the apple. The intent for the bee
is to dodge the skull and if they dont then the bee dies, game ends and score resets to 0. Also, when the skull touches
the bee then it plays the sound of a skeleton clicking together
